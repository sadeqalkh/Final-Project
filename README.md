...
<img width="599" alt="Screen Shot 2020-05-14 at 7 46 21 PM" src="https://user-images.githubusercontent.com/60816393/81959595-c2d3c600-9620-11ea-99f1-797a5b3ee389.png">

Designing the background mechanism in fusion 360 from the first time indeed carried some issues which seemed confusing. In which, I have discovered by research through MIT mechanism page "http://courses.csail.mit.edu/6.S080/lectures/05_all.pdf" that I should change the form of my initial linkage. Based on the "Original patent: angulated scissor" page, two combined linkages should be considered. For instance, the first linkage as A and second linkage as B, if A was in 0 degrees, B should be assumingly in the range of 30 to 60 degrees from the origin point. As I researched many aspects of this topic, I have discovered that this site "http://www.snels-design.com/en/main/gallery/expanding_circle" that B can be either 45 or 60 degrees from the origin point. I implemented 60 degrees in my design to explore the outcome, and indeed, it was working; however, the linkages in the design's final part lacked two joints. One was in the middle, and the other was at the top of the linkage. This issue might be the result of not implementing 45 degrees or, it might be a mistake in having equal sides from both A and B.

<img width="920" alt="Screen Shot 2020-05-14 at 7 46 43 PM" src="https://user-images.githubusercontent.com/60816393/81959598-c36c5c80-9620-11ea-9d26-80953248f95e.png">
